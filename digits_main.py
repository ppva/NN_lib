...
NN = NeuralNetwork(eval_method="one-hot")
...
pr.shuffle(dataset)
NN.fit_ds(dataset, 10, optimizer=opt,batch_size=32,loss_func='mse', verbose=2)
...
sgd = kopt.SGD(lr=0.001, momentum=0.0, decay=0.00 )
